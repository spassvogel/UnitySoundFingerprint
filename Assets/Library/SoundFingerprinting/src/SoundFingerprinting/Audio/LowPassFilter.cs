    ...
    internal class LowPassFilter : ILowPassFilter
    {
        ...
        public float[] FilterAndDownsample(float[] samples, int sourceSampleRate, int targetSampleRate)
        {
            if (targetSampleRate != 5512)
                throw new ArgumentException(String.Format("Target sample {0} rate not supported!", targetSampleRate));
            ...
            throw new ArgumentException(String.Format("Not supported sample rate {0}", sourceSampleRate));
        }
